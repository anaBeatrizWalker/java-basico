...
public class MetodosMap {
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println(carrosPopulares); //{gol=15.2, kwid=15.6, uno=15.6, hb20=14.5, mobi=16.1}

        System.out.println("\nConfira se o modelo tucson está no dicionário: " + carrosPopulares.containsKey("tucson")); //false

        System.out.println("\nExiba o consumo do uno: " + carrosPopulares.get("uno")); //15.6

        //System.out.println("Exiba o terceiro modelo adicionado: "); //

        System.out.println("\nExiba os modelos: ");
        Set<String> modelos = carrosPopulares.keySet(); //retorna um set
        System.out.println(modelos); //[gol, kwid, uno, hb20, mobi]

        System.out.println("\nExiba os consumos dos carros: ");
        Collection<Double> consumos = carrosPopulares.values(); //retorna uma collection
        System.out.println(consumos); //[15.2, 15.6, 15.6, 14.5, 16.1]

        System.out.println("\nExiba o modelo mais econômico e seu consumo: ");
        Double consumoMaisEficiente = Collections.max(carrosPopulares.values());
        Set<Map.Entry<String, Double>> entries = carrosPopulares.entrySet(); //interface Entry
        ...
        for (Map.Entry<String, Double> entry: carrosPopulares.entrySet()) {
            if(entry.getValue().equals(consumoMenosEficiente)) {
                ...
                System.out.println("Modelo menos eficiente: " + modeloMenosEficiente + " - " + consumoMenosEficiente); //hb20 - 14.5
            }
        }
        ...
        System.out.println("\nExiba a soma dos consumos: " + soma); //77.0

        System.out.println("\nExiba a média dos consumos deste dicionário de carros: " + (soma/carrosPopulares.size())); //15.4
        ...
        System.out.println(carrosPopulares);//{gol=15.2, hb20=14.5, mobi=16.1}
        ...
        System.out.println("\nConfira se o dicionário está vazio: " + carrosPopulares.isEmpty()); //true
    }
}
